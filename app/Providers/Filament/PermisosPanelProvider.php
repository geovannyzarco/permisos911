        ...
        return $panel
            ...
            ->navigationItems([
                NavigationItem::make('Manual de Usuario')
                    ->url('/documentacion/manual_usuario.html', shouldOpenInNewTab: true)
                ...
                NavigationItem::make('Manual del Administrador')
                    ->url('/documentacion/manual_administrador.html', shouldOpenInNewTab: true)
                ...
                NavigationItem::make('Manual de Instalación')
                    ->url('/documentacion/manual_instalacion.html', shouldOpenInNewTab: true)

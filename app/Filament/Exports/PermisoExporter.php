...
class PermisoExporter extends Exporter
{
    ...
    public static function getColumns(): array
    {
        return [
            ...
            ExportColumn::make('estado.nombre')->label('Estado'),
            ...
            ExportColumn::make('estadoUnidad.nombre')->label('Estado unidad'),
            ExportColumn::make('fecha_aprobacion_unidad')->label('Fecha aprobación unidad'),
